...
class LinkedList {
    ...
    insert(index, value) {
        ...
        if (temp) {
            // actualy this if statement is unnecesarry, because the get index will always returning a value because the index is always a valid index since we've alredy prevend the invalid index above
            newNode.next = temp.next;
            temp.next = newNode;
            this.length++;
        }
...
let listBubleSort = new LinkedList(4);

listBubleSort.push(1);
listBubleSort.push(3);
listBubleSort.push(2);
let sortedList = listBubleSort.bubbleSort(listBubleSort);
console.log(sortedList);
console.log(LinkedList.print(sortedList));
